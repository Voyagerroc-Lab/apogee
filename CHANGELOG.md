...
## [0.2.2](https://github.com/darshi1337/apogee/compare/v0.2.1...v0.2.2) (2026-09-17)
...
* **extractors:** Add Dev.to article extractor ([#169](https://github.com/darshi1337/apogee/issues/169)) ([64e2f3d](https://github.com/darshi1337/apogee/commit/64e2f3d665b5532c38788e4cd5950a54984c5c1a))
...
* Address review nits for notification cap ([#252](https://github.com/darshi1337/apogee/issues/252)) ([c5fc538](https://github.com/darshi1337/apogee/commit/c5fc53804125d12aa108ad0a26b40ff9e6d1b6f2))
...
* Await finalize path, preserve text and surface error on storage failure ([317e05c](https://github.com/darshi1337/apogee/commit/317e05c9240c278b538e588d779ffb35ea7a1e52))
...
* **background:** Make empty-content summarize branches throw instead of silently returning ([bf569a5](https://github.com/darshi1337/apogee/commit/bf569a5b54de514bac4f55b77bdcfdeccc6ccf86)), closes [#253](https://github.com/darshi1337/apogee/issues/253)
...
* Bound SW/offscreen ingress, cap map chunks and stream text ([#269](https://github.com/darshi1337/apogee/issues/269)) ([6cedfa0](https://github.com/darshi1337/apogee/commit/6cedfa0f9d59325a957a96707a2d51b5cd11b09d))
* Bound SW/offscreen ingress, cap map chunks and stream text ([#269](https://github.com/darshi1337/apogee/issues/269)) ([91f8903](https://github.com/darshi1337/apogee/commit/91f89036bfa60a549806ceef21c673e03baef64f))
...
* Bump addons-linter, guard dist from vulnerable dev-only packages ([d05c326](https://github.com/darshi1337/apogee/commit/d05c32652d4791154ef91e4a0cab110d8e479e3b))
...
* Cap notification message length to prevent truncation ([#252](https://github.com/darshi1337/apogee/issues/252)) ([cb347cf](https://github.com/darshi1337/apogee/commit/cb347cf3284cb00bc6ef34694762c3b0cfb669f7))
* Cap notification message length to prevent truncation ([#252](https://github.com/darshi1337/apogee/issues/252)) ([02e49fb](https://github.com/darshi1337/apogee/commit/02e49fbd24d29832f57e1b3f7d3406cf9846d9e1))
...
* **deps:** Bump sharp to 0.35.4 and pin js-yaml to 4.3.2 ([634abd3](https://github.com/darshi1337/apogee/commit/634abd37f9bc11267ca578ec9df4fe4f048c0b7a))
* **deps:** Bump sharp to 0.35.4 and pin js-yaml to 4.3.2 ([3fdfc2b](https://github.com/darshi1337/apogee/commit/3fdfc2bac06eb0aa7c006b271346bae5021c90f1))
...
* **docs:** Accessibility pass on the landing page ([#240](https://github.com/darshi1337/apogee/issues/240)) ([76de301](https://github.com/darshi1337/apogee/commit/76de301c31ab18318843188e319da92766934c94))
* **docs:** Responsive nav and reduced-motion pass ([#241](https://github.com/darshi1337/apogee/issues/241)) ([91de287](https://github.com/darshi1337/apogee/commit/91de287f13d05cafb3296819e0c6f4527cf4dc14))
* **docs:** Responsive nav and reduced-motion pass ([#241](https://github.com/darshi1337/apogee/issues/241)) ([574fc68](https://github.com/darshi1337/apogee/commit/574fc6892755720ccc0d38850308ace475072637))
* Drop dead highlight overlay, rename dev script, add coverage flag ([aa4cb98](https://github.com/darshi1337/apogee/commit/aa4cb9836d79b0e0a7c4625718e9299334e80e84))
...
* Gate multi-tab persist on private hosts, bound prompt to model budget, add cancel signal ([da2a7df](https://github.com/darshi1337/apogee/commit/da2a7dfad3fbf1a0997c83271f8e7d69df06973c))
...
* Multi-tab view-state shape, subtitle caps, model allow-list, rag key ([6f7cd8c](https://github.com/darshi1337/apogee/commit/6f7cd8c1d7b92f58f8a1d160d7d612233529e7c9))
...
* Orphan view-state keys, dedupe highlight matcher, harden generate-text ([ae48240](https://github.com/darshi1337/apogee/commit/ae48240fc30f9412c3ae3c7e991dee7ae5bd2fdc))
...
* Per-engine inference locks with timeout, keep healthy engine on transient error ([bac0a21](https://github.com/darshi1337/apogee/commit/bac0a21949501cba9673f99daf88b770271b48d2))
* Per-engine inference locks with timeout, keep healthy engine on transient error ([#268](https://github.com/darshi1337/apogee/issues/268)) ([6d81524](https://github.com/darshi1337/apogee/commit/6d81524ef7df3a21edb95c3a4419504e5d2aa805))
...
* Quick audit wins (viewport, icons dup, CSP, ollama leak, abort drain, privateHosts count) ([b58f86a](https://github.com/darshi1337/apogee/commit/b58f86a73226aad99dc885c187dfb6207d6accc3))
...
* Remove dead plaintext export, getURL fallbacks, PUA link token ([49129f4](https://github.com/darshi1337/apogee/commit/49129f45ffc2f53af2c4a20f3486c31675b44857))
...
* Restore Ollama connectivity for loopback variants without opening SSRF ([0fc5c1b](https://github.com/darshi1337/apogee/commit/0fc5c1bd87fbdec0153f8cdda6297e2fa0d57053))
...
* Reuse cached content when re-rendering a summary in a different format ([#177](https://github.com/darshi1337/apogee/issues/177)) ([1cef996](https://github.com/darshi1337/apogee/commit/1cef9964b376c273dbb33abbe17ec486e5ba9170))
* Reuse cached content when re-rendering a summary in a different format ([#177](https://github.com/darshi1337/apogee/issues/177)) ([e85c92c](https://github.com/darshi1337/apogee/commit/e85c92cb967c5c1f2da7df02a3aad07cb8a5f057))
...
* Stop triple-buffering 50MB file uploads, cap expanded text ([db4fda5](https://github.com/darshi1337/apogee/commit/db4fda5501d2a36529b54ae59133713c0c30b036))
...
* Validate summary link protocols ([d745937](https://github.com/darshi1337/apogee/commit/d745937b576699f5bf3ba58a60adb0af450e1610))
* Validate summary link protocols ([6c70c08](https://github.com/darshi1337/apogee/commit/6c70c08df47821940c9dc21b0bcca7017b1d53da)), closes [#266](https://github.com/darshi1337/apogee/issues/266)
